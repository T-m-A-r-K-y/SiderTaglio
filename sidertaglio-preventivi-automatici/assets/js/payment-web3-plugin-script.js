jQuery(document).ready(function () {
    ...
    jQuery("#standardErcCheckbox").change(function () {
        var dropDown = jQuery(".secondDropDown");
        dropDown.toggle();
    });
    ...
    jQuery("#addTokenBtn").click(function (){
    ...
    // jQuery(".token-row .erc20").change(function () {
    //     // Get values from input fields
    //     console.log('clicked')
    //     var dropDown = jQuery(this).closest(".token-row").find(".abi-dropdown");
    //     dropDown.toggle();
    // });
